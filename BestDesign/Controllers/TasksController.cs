...
namespace BestDesign.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> TaskForEmp()
        {
            ...
            var topContext = _context.Tasks.Where(s => s.UserId == User.Identity.Name);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Date,Description,UserId")] Tasks tasks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Date,Description,UserId")] Tasks tasks)
        {
            if (id != tasks.Id)
            {
                return NotFound();
